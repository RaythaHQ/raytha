...
namespace Raytha.Migrations.SqlServer
{
    ...
    public partial class v1_3_0 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentNavigationMenuItemId = table.Column<Guid>(
                        type: "uniqueidentifier",
                        nullable: true
                    ),
                    NavigationMenuId = table.Column<Guid>(
                        type: "uniqueidentifier",
                        nullable: false
                    ),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NavigationMenuItemsJson = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
                    NavigationMenuId = table.Column<Guid>(
            ...
            migrationBuilder.DropColumn(name: "WebTemplateId", table: "DeletedContentItems");
            ...
            migrationBuilder.DropColumn(name: "WebTemplateId", table: "ContentItems");
            ...
            migrationBuilder.DropIndex(name: "IX_Views_WebTemplateId", table: "Views");
            ...
            migrationBuilder.DropColumn(name: "WebTemplateId", table: "Views");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropIndex(name: "IX_WebTemplates_ThemeId", table: "WebTemplates");

            migrationBuilder.DropColumn(name: "ThemeId", table: "WebTemplates");

            migrationBuilder.DropColumn(name: "ActiveThemeId", table: "OrganizationSettings");

            migrationBuilder.DropColumn(name: "WebTemplateIdsJson", table: "DeletedContentItems");
