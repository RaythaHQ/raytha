...
namespace Raytha.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260921025511_v2_1_0")]
    partial class v2_1_0
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Raytha.Domain.Entities.EmailLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Raytha.Domain.Entities.Webhook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Raytha.Domain.Entities.WebhookDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Raytha.Domain.Entities.WebhookDelivery", b =>
                {
                    b.HasOne("Raytha.Domain.Entities.Webhook", "Webhook")
                        .WithMany("Deliveries")
