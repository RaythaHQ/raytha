...
public class InsertVariableTemplateFactory
{
    ...
    public static InsertVariableTemplateFactory ContentType =>
        new("ContentType", "ContentType", new ContentType_RenderModel());
    public static InsertVariableTemplateFactory ContentItem =>
        new("ContentItem", "Target", new ContentItem_RenderModel());
    public static InsertVariableTemplateFactory ContentItemListResult =>
        new("ContentItemListResult", "Target", new ContentItemListResult_RenderModel());
    public static InsertVariableTemplateFactory NavigationMenu =>
        new("Menu", "Menu", NavigationMenu_RenderModel.Empty());
    public static InsertVariableTemplateFactory NavigationMenuItem =>
        new("MenuItem", "MenuItem", NavigationMenuItem_RenderModel.Empty());

    public static InsertVariableTemplateFactory LoginWithEmailAndPasswordPage =>
        new(
            BuiltInWebTemplate.LoginWithEmailAndPasswordPage,
            "Target",
            new LoginSubmit_RenderModel()
        );
    public static InsertVariableTemplateFactory LoginWithMagicLinkPage =>
        new(BuiltInWebTemplate.LoginWithMagicLinkPage, "Target", new LoginSubmit_RenderModel());
    public static InsertVariableTemplateFactory LoginWithMagicLinkSentPage =>
        new(BuiltInWebTemplate.LoginWithMagicLinkSentPage, "Target", new EmptyTarget_RenderModel());
    public static InsertVariableTemplateFactory ForgotPasswordPage =>
        new(
            BuiltInWebTemplate.ForgotPasswordPage,
            "Target",
            new ForgotPasswordSubmit_RenderModel()
        );
    public static InsertVariableTemplateFactory ForgotPasswordCompletePage =>
        new(
            BuiltInWebTemplate.ForgotPasswordCompletePage,
            "Target",
            new ForgotPasswordCompleteSubmit_RenderModel()
        );
    public static InsertVariableTemplateFactory ForgotPasswordResetLinkSentPage =>
        new(
            BuiltInWebTemplate.ForgotPasswordResetLinkSentPage,
            "Target",
            new EmptyTarget_RenderModel()
        );
    public static InsertVariableTemplateFactory ForgotPasswordSuccessPage =>
        new(BuiltInWebTemplate.ForgotPasswordSuccessPage, "Target", new EmptyTarget_RenderModel());
    public static InsertVariableTemplateFactory ChangeProfilePage =>
        new(BuiltInWebTemplate.ChangeProfilePage, "Target", new ChangeProfileSubmit_RenderModel());
    public static InsertVariableTemplateFactory ChangePasswordPage =>
        new(BuiltInWebTemplate.ChangePasswordPage, "Target", new ChangeProfileSubmit_RenderModel());
    public static InsertVariableTemplateFactory UserRegistrationForm =>
        new(BuiltInWebTemplate.UserRegistrationForm, "Target", new CreateUserSubmit_RenderModel());
    public static InsertVariableTemplateFactory UserRegistrationFormSuccess =>
        new(
    ...
    public static InsertVariableTemplateFactory Error403 =>
        new(BuiltInWebTemplate.Error403, "Target", new GenericError_RenderModel());
    public static InsertVariableTemplateFactory Error404 =>
        new(BuiltInWebTemplate.Error404, "Target", new GenericError_RenderModel());
    public static InsertVariableTemplateFactory Error500 =>
        new(BuiltInWebTemplate.Error500, "Target", new GenericError_RenderModel());
    public static InsertVariableTemplateFactory _Layout =>
        new(BuiltInWebTemplate._Layout, "Target", new GenericError_RenderModel());
    public static InsertVariableTemplateFactory _LoginLayout =>
        new(BuiltInWebTemplate._LoginLayout, "Target", new GenericError_RenderModel());
