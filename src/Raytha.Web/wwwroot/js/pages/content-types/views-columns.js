/**
 * Content Type Views - Columns Page
 * Handles drag-and-drop reordering of view columns using SortableJS
 */
...
/**
 * Initialize sortable column list
 */
function initSortable() {
  ...
  async function onReordered(evt) {
    ...
    try {
      ...
      if (!response.ok) {
        showNotification('Failed to save column order ❌', false);
      } else {
        showNotification('Column order saved ✅', true);
      }
    } catch (error) {
