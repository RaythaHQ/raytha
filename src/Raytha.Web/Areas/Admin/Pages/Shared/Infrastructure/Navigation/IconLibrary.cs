...
/// <summary>
/// Centralized SVG icon library for navigation and UI elements.
/// </summary>
public static class IconLibrary
{
    ...
    public const string Divider = ""; // No icon for dividers
}
