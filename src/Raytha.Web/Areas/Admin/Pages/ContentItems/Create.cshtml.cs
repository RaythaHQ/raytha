...
public class Create : BaseHasFavoriteViewsPageModel
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        var fieldValues = CurrentView.ContentType.ContentTypeFields.Select(p => new FieldValueViewModel
        {
            Label = p.Label,
            DeveloperName = p.DeveloperName,
            AvailableChoices = p.Choices?.Select(b => new FieldValueChoiceItemViewModel
            {
                Label = b.Label,
        ...
        else
        {
            ...
            var fieldValues = CurrentView.ContentType.ContentTypeFields.Select(p => new FieldValueViewModel
            {
                ...
                AvailableChoices = p.Choices?.Select(b => new FieldValueChoiceItemViewModel
                {
                    ...
                    DeveloperName = b.DeveloperName,
                    Disabled = b.Disabled,
                    Value = p.FieldType.DeveloperName == BaseFieldType.MultipleSelect ? Form.FieldValues.First(c => c.DeveloperName.ToDeveloperName() == p.DeveloperName)
                ...
                IsRequired = p.IsRequired,
                Description = p.Description,
                RelatedContentItemPrimaryField = Form.FieldValues.First(c => c.DeveloperName.ToDeveloperName() == p.DeveloperName).RelatedContentItemPrimaryField,
                RelatedContentTypeId = p.RelatedContentTypeId,
                Value = Form.FieldValues.First(c => c.DeveloperName.ToDeveloperName() == p.DeveloperName).Value
            }).ToArray();
