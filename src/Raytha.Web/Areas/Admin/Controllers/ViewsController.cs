...
public class ViewsController : BaseController
{
    ...
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views",
        Name = "viewsindex"
    )]
    ...
    [ServiceFilter(typeof(GetOrSetRecentlyAccessedViewFilterAttribute))]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/create",
        Name = "viewscreate"
    )]
    public async Task<IActionResult> Create(string duplicateFromId)
    {
        var response = await Mediator.Send(
            new GetContentTypeByDeveloperName.Query
            {
        ...
        {
            duplicatedView = (
                await Mediator.Send(new GetViewById.Query { Id = duplicateFromId })
            ).Result;
        }
        ...
        var viewModel = new ViewsCreate_ViewModel
        {
            ...
            DeveloperName =
                duplicatedView != null ? duplicatedView.DeveloperName + "_duplicate" : string.Empty,
    ...
    [ServiceFilter(typeof(GetOrSetRecentlyAccessedViewFilterAttribute))]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/edit/{{viewId}}",
        Name = "viewsedit"
    )]
    ...
    [ServiceFilter(typeof(GetOrSetRecentlyAccessedViewFilterAttribute))]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/public-settings/{{viewId}}",
        Name = "viewspublicsettings"
    )]
    public async Task<IActionResult> PublicSettings()
    {
        ...
        var viewModel = new ViewsPublicSettings_ViewModel
        {
            ...
            IgnoreClientFilterAndSortQueryParams = response
                .Result
    ...
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/set-as-home-page/{{viewId}}",
        Name = "viewssetashomepage"
    )]
    [HttpPost]
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_READ_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/favorite",
        Name = "viewsfavorite"
    )]
    [HttpPost]
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_READ_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/unfavorite",
        Name = "viewsunfavorite"
    )]
    [HttpPost]
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_EDIT_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/delete",
        Name = "viewsdelete"
    )]
    [HttpPost]
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_EDIT_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/columns",
        Name = "viewscolumns"
    )]
    public async Task<IActionResult> Columns()
    {
        ...
        var columnListItems = response
            .Result.Items.Select(p => new ViewsColumnsListItem_ViewModel
            {
                Label = p.Label,
                DeveloperName = p.DeveloperName,
        ...
        var builtInListItems = BuiltInContentTypeField
            .ReservedContentTypeFields.Select(p => new ViewsColumnsListItem_ViewModel
            {
                Label = p.Label,
                DeveloperName = p.DeveloperName,
                Selected = CurrentView.Columns.Contains(p.DeveloperName),
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_EDIT_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/columns/reorder/{{developerName}}",
        Name = "viewscolumnsreorderajax"
    )]
    [HttpPatch]
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_EDIT_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/columns/toggle/{{developerName}}",
        Name = "viewscolumnstoggle"
    )]
    [HttpPost]
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_EDIT_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/sort",
        Name = "viewssort"
    )]
    public async Task<IActionResult> Sort()
    {
        ...
        var builtInListItems = BuiltInContentTypeField
            .ReservedContentTypeFields.Select(p => new ViewsSortListItem_ViewModel
            {
                Label = p.Label,
                DeveloperName = p.DeveloperName,
                Selected = CurrentView.Sort.Any(c => c.DeveloperName == p.DeveloperName),
        ...
        {
            SelectedColumns = selectedColumns.ToArray(),
            NotSelectedColumns = notSelectedColumns.ToDictionary(
                p => p.DeveloperName,
                p => p.Label
            ),
        };
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_EDIT_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/sort/remove/{{developerName}}",
        Name = "viewssortremove"
    )]
    [HttpPost]
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_EDIT_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/sort/add",
        Name = "viewssortadd"
    )]
    [HttpPost]
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_EDIT_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/sort/reorder/{{developerName}}",
        Name = "viewssortreorderajax"
    )]
    [HttpPatch]
    ...
    [Authorize(Policy = BuiltInContentTypePermission.CONTENT_TYPE_EDIT_PERMISSION)]
    [Route(
        $"{RAYTHA_ROUTE_PREFIX}/{{{RouteConstants.CONTENT_TYPE_DEVELOPER_NAME}}}/views/{{viewId}}/filter",
        Name = "viewsfilter"
    )]
    public async Task<IActionResult> Filter()
    {
        ...
        var model = new ViewsFilter_ViewModel { ContentTypeFields = contentTypeFields.ToArray() };
    ...
    {
        IEnumerable<FilterConditionInputDto> filterItemsAsObj = JsonSerializer.Deserialize<
            IEnumerable<FilterConditionInputDto>
        >(json);

        var response = await Mediator.Send(
            new EditFilter.Command { Id = CurrentView.Id, Filter = filterItemsAsObj }
        );
