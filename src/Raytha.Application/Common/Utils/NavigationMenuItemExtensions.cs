...
{
    public static IReadOnlyCollection<TModel> BuildTree<TModel>(this IReadOnlyCollection<NavigationMenuItemDto> navigationMenuItems,
        ...
        ShortGuid? parentNavigationMenuItemId = null)
    {
        ...
        return filteredNavigationMenuItemsByParent
            .Select(nmi => createModel(nmi, navigationMenuItems.BuildTree(createModel, nmi.Id), filteredNavigationMenuItemsByParent.Count))
            .ToList();
    }
    ...
    public static IReadOnlyCollection<ShortGuid> GetNestedNavigationMenuItemIds(this IReadOnlyCollection<NavigationMenuItemDto> navigationMenuItems, ShortGuid id)
    {
        ...
        return nestedNavigationMenuItemIds.Concat(nestedNavigationMenuItemIds.SelectMany(navigationMenuItems.GetNestedNavigationMenuItemIds)).ToArray();
    }
}