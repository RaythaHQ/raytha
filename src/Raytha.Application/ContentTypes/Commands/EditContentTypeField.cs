...
public class EditContentTypeField
{
        ...
        public Validator(IRaythaDbContext db)
        {
            ...
            RuleFor(x => x)
                .Custom(
                    (request, context) =>
                    {
                        var entity = db.ContentTypeFields.FirstOrDefault(p =>
                        ...
                        )
                        {
                            context.AddFailure(
                                "Choices",
                                "You must have at least one choice specified."
                            );
                            return;
                        }
    ...
    public class Handler : IRequestHandler<Command, CommandResponseDto<ShortGuid>>
    {
        ...
        )
        {
            ...
            if (BaseFieldType.From(entity.FieldType).HasChoices)
                entity.Choices = request.Choices.Select(p => new ContentTypeFieldChoice
                {
