...
public class GetRoles
{
    ...
    public class Handler : RequestHandler<Query, IQueryResponseDto<ListResultDto<RoleDto>>>
    {
        ...
        protected override IQueryResponseDto<ListResultDto<RoleDto>> Handle(Query request)
        {
            var query = _db.Roles
