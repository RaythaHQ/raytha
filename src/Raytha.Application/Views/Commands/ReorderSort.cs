...
public class ReorderSort
{
    ...
    public class Handler : IRequestHandler<Command, CommandResponseDto<ShortGuid>>
    {
        ...
        public async Task<CommandResponseDto<ShortGuid>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var columns = entity.Sort.Select(p => p.DeveloperName).ToList();
            ...
            ObservableCollection<ColumnSortOrder> columnsAsMovable = new ObservableCollection<ColumnSortOrder>(entity.Sort);
            columnsAsMovable.Move(originalColumnOrder, newColumnOrder);
            entity.Sort = columnsAsMovable;
